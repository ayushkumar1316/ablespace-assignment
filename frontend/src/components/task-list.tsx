                  ...
                  {!isCollapsed &&
                    sectionTasks.map((task) => (
                      ...
                      >
                        ...
                        <td className="px-3 py-2.5">
                          <div className="text-sm font-medium text-foreground" title={task.title}>{task.title}</div>
                          <div className="text-xs text-foreground-subtle" title={task.description}>{task.description}</div>
                        </td>
                        {fields.priority && (
                          <td className="px-3 py-2.5">
